<template>
  <div class="xorake flex flex-col justify-between">
    ...
    <div class="content">
      <div class="w-full flex justify-center rounded-md mt-8 mb-8">
        <VueSlickCarousel class="VueSlickCarousel" :arrows="true" :autoplay="true" :speed="900"  :autoplaySpeed="5000" :dots="true">
          <img class="rounded-md" src="../../../assets/images/xorake2.jpg" alt="جانبی">
          <img class="rounded-md" src="../../../assets/images/xorake.jpg" alt="جانبی">
        </VueSlickCarousel>
      </div>
